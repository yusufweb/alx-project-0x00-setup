...
const Card: React.FC = () => {
  return (
    <div className="w-[95%] h-screen mx-auto">
      <div className="flex flex-col md:flex-row justify-between gap-4 p-4 w-[100%]">
        <div className="h-[500px] w-[378.56px] cursor-pointer hover:shadow-lg hover:rounded-lg p-4">
          <Image
            width={350}
            height={250}
            src={HOUSE_IMAGE}
          ...
          <div className="py-4 flex gap-2 mt-2">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
              ...
              <p className=" font-medium text-[25px] ml-2">4.76</p>
            </div>
          </div>
        ...
        <div className="h-[500px] w-[378.56px] cursor-pointer hover:shadow-lg hover:rounded-lg p-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
              <Image src={STAR_IMAGE} alt="star" />
              <p className=" font-medium text-[20px] ml-2">4.76</p>
            </div>
          </div>
          <div className="flex justify-between mt-4">
            <div className=" grid grid-cols-3 border w-[156px] rounded-full px-2 py-1">
      ...
      <div className="flex gap-4 my-8 items-center p-4">
        <Button style="rounded-sm w-auto p-4 w-[20px] h-[40px] text-[12px] hover:bg-red-800 cursor-pointer" title="Small Button" />
        <Button style="rounded-md w-auto p-4 w-[80px] h-[60px] text-[24px] hover:bg-red-800 cursor-pointer" title="Medium Button" />
        <Button style="rounded-full w-auto p-4 w-[100px] h-[80px] text-[30px] hover:bg-red-800 cursor-pointer" title="Large Button" />
      </div>
    </div>
  );
};
